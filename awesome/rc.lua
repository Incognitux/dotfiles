...
awful.placement.bottom(bar,{margins = {bottom = 5}})]]
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "q", function () awful.spawn(browser) end,
              {description = "open a fox on fire", group = "apps"}),
    awful.key({ modkey }, "e", function () awful.spawn(fileManager) end,
              {description = "open file manager", group = "apps" }),
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("flameshot gui") end,
              {description = "take a screenshot", group = "utility"}),
    awful.key({ modkey, "Control" }, "q", function () awful.spawn("flatpak run org.qutebrowser.qutebrowser") end,
              {description = "open qutebrowser", group = "apps"}),    
    ...
    awful.key({ modkey },  "a", function () awful.spawn("/home/incognitux/.config/rofi/launcher.sh")    end,
...
awful.spawn.with_shell("~/.config/awesome/custom/awesomeAutorun.sh")
